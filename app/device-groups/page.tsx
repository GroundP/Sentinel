...
import { mockDeviceGroups, DeviceGroup } from "@/data/mock-device-groups";
import { Plus, MoreVertical, Monitor } from "lucide-react";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
const StatusCellRenderer = (params: ICellRendererParams<DeviceGroup>) => {
...
// Device count cell renderer
const DeviceCountCellRenderer = (params: ICellRendererParams<DeviceGroup>) => {
...
export default function DeviceGroupsPage() {
  const [rowData] = useState<DeviceGroup[]>(mockDeviceGroups);

  const columnDefs = useMemo<ColDef<DeviceGroup>[]>(
    () => [
      {
      ...
      },
      {
        ...
        headerName: "Devices",
        width: 120,
        cellRenderer: DeviceCountCellRenderer,
      },
      {
        field: "location",
        headerName: "Location",
